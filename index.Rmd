...
* Examples
  1. Fitting the DM on Ratcliff and Rouder (1998) data (group activity) with MLE
  2. Fitting the RLDM on Fontanesi and colleagues (2019) data with hierarchical Bayesian estimation
